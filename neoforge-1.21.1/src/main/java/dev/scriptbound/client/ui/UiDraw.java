...
public final class UiDraw
{
    ...
    public static void fillRoundedTop(GuiGraphics graphics, int x, int y, int w, int h, int color, int r)
    {
        ...
        com.mojang.blaze3d.vertex.BufferBuilder bufferbuilder = tesselator.begin(com.mojang.blaze3d.vertex.VertexFormat.Mode.TRIANGLE_FAN, com.mojang.blaze3d.vertex.DefaultVertexFormat.POSITION_COLOR);

        bufferbuilder.addVertex(matrix, x + w / 2.0f, y + h, 0.0f).setColor(red, green, blue, a);
        ...
        bufferbuilder.addVertex(matrix, x + w, y + h, 0.0f).setColor(red, green, blue, a);
        bufferbuilder.addVertex(matrix, x, y + h, 0.0f).setColor(red, green, blue, a);
    ...
    public static void fillRounded(GuiGraphics graphics, int x, int y, int w, int h, int color, int r)
    {
        ...
        bufferbuilder.addVertex(matrix, x + w / 2.0f, y + h / 2.0f, 0.0f).setColor(red, green, blue, a);
        ...
        bufferbuilder.addVertex(matrix, x, y + r, 0.0f).setColor(red, green, blue, a);
    ...
    public static void outlineRounded(GuiGraphics graphics, int x, int y, int w, int h, int color, int r)
    {
        ...
        com.mojang.blaze3d.vertex.Tesselator tesselator = com.mojang.blaze3d.vertex.Tesselator.getInstance();
        com.mojang.blaze3d.vertex.BufferBuilder bufferbuilder = tesselator.begin(com.mojang.blaze3d.vertex.VertexFormat.Mode.DEBUG_LINE_STRIP, com.mojang.blaze3d.vertex.DefaultVertexFormat.POSITION_COLOR);
    ...
    private static void drawCorner(com.mojang.blaze3d.vertex.BufferBuilder builder, org.joml.Matrix4f matrix, float cx, float cy, float radius, int startAngle, int endAngle, float r, float g, float b, float a) {
        for (int i = startAngle; i <= endAngle; i += 5) {
            ...
            builder.addVertex(matrix, cx + (float) Math.cos(rad) * radius, cy + (float) Math.sin(rad) * radius, 0.0f).setColor(r, g, b, a);
        }
    }
