...
public record EffectAction(String effectId, int duration, int amplifier, boolean showParticles) implements TriggerAction
{
    ...
    public void execute(TriggerContext context)
    {
        ...
        net.minecraft.core.Holder<MobEffect> effect = net.minecraft.core.registries.BuiltInRegistries.MOB_EFFECT.getHolder(net.minecraft.resources.ResourceLocation.parse(this.effectId)).orElse(null);
