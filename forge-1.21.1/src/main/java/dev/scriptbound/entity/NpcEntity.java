...
public class NpcEntity extends Mob
{
    ...
    protected void defineSynchedData(net.minecraft.network.syncher.SynchedEntityData.Builder builder)
    {
        ...
        builder.define(BLUEPRINT_ID, "");
        builder.define(INTERACT_TRIGGER, "");
        builder.define(ON_DEATH_TRIGGER, "");
        builder.define(FORM_JSON, "");
        builder.define(DIALOGUE_ID, "");
    }
    ...
    {
        if (formJson != null && !formJson.equals(this.entityData.get(FORM_JSON))) {
            dev.scriptbound.ScriptBoundMod.LOGGER.info("[DEBUG] NpcEntity '{}' setFormJson. Side: {}, Length: {}", this.getBlueprintId(), this.level().isClientSide ? "CLIENT" : "SERVER", formJson.length());
        }
    ...
    public void readAdditionalSaveData(CompoundTag tag)
    {
        ...
        dev.scriptbound.ScriptBoundMod.LOGGER.info("[DEBUG] NpcEntity '{}' load (readAdditionalSaveData). Form length: {}", this.getBlueprintId(), tag.getString("form").length());
